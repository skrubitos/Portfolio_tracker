...
ax.text(-2,0.80, f'Total USD Amount: {sum(total):.2f}$',fontsize=10,color="black",verticalalignment="center",horizontalalignment='center')

oduzimanje=0.15

for ticker in tickers:
    ax.text(-2,0.8-oduzimanje,f'{ticker}:{total[tickers.index(ticker)]}',color='black',fontsize=12,verticalalignment="center",horizontalalignment='center')
    oduzimanje+= 0.15
